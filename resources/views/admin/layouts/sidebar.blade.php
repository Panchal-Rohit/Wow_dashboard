            ...
            <ul class="sidebar-menu" id="sidebar-menu">
                <li class="dropdown">
                    ...
                    <ul class="sidebar-submenu">
                        ...
                        <li>
                            <a href="index-15.html"><i class="ri-circle-fill circle-icon text-purple w-auto"></i>
                                Project Management
                            </a>
                        </li>
                        <li>
                            <a href="index-16.html"><i class="ri-circle-fill circle-icon text-success-main w-auto"></i>
                                Call Center</a>
                        </li>
                        <li>
                            <a href="index-17.html"><i class="ri-circle-fill circle-icon text-danger-main w-auto"></i>
                                Sass</a>
                        </li>
                        <li>
                            <a href="index-18.html"><i class="ri-circle-fill circle-icon text-info-main w-auto"></i>
                                Sales</a>
                        </li>
                        <li>
                            <a href="index-19.html"><i class="ri-circle-fill circle-icon text-warning-main w-auto"></i>
                                Real Estate </a>
                        </li>
                    </ul>
                </li>
                    ...
                    <ul class="sidebar-submenu">
                        <li>
                            <a href="gallery-grid.html"><i
                                    class="ri-circle-fill circle-icon text-primary-600 w-auto"></i> Gallery
                                Grid</a>
                        </li>
                        <li>
                        ...
                        <li>
                            <a href="gallery-masonry.html"><i
                                    class="ri-circle-fill circle-icon text-info-main w-auto"></i> Gallery
                                Masonry</a>
                        </li>
                        <li>
                    ...
                    <ul class="sidebar-submenu">
                        ...
                        <li>
                            <a href="internal-server.html"><i
                                    class="ri-circle-fill circle-icon text-primary-main w-auto"></i> Internal
                                Server</a>
                        </li>
                        <li>
